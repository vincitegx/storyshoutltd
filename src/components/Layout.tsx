...
import { Menu, X, Sun, Moon, Server, Music, Award, ShieldAlert } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex space-x-8 items-center font-medium">
              <Link id="nav-software" to="/software" className={`hover:text-brand-teal transition-colors py-2 text-sm ${location.pathname === '/software' ? 'text-brand-teal' : darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
                SaaS software
              </Link>
              <Link id="nav-music" to="/music" className={`hover:text-brand-teal transition-colors py-2 text-sm ${location.pathname === '/music' ? 'text-brand-teal' : darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
                Music Records
              </Link>
          ...
          {menuOpen && (
            ...
            >
              <div className="px-4 pt-3 pb-6 space-y-3">
                <Link 
                  to="/software" 
                  className={`block px-3 py-2 rounded-lg text-base font-medium ${location.pathname === '/software' ? 'text-brand-teal bg-brand-teal/5' : 'text-slate-400'}`}
                >
                  SaaS Software
                </Link>
                <Link 
                  to="/music" 
                  className={`block px-3 py-2 rounded-lg text-base font-medium ${location.pathname === '/music' ? 'text-brand-teal bg-brand-teal/5' : 'text-slate-400'}`}
                >
                  Music Records
                </Link>
                <Link 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="col-span-1 md:col-span-1 space-y-4">
              ...
              <p className="text-sm leading-relaxed">
                A modern Nigerian hybrid operating high-delivery campaign softwares and independent music management at the frontier of technology and sound.
              </p>
              <div className="pt-2">
            ...
            <div className="space-y-4">
              <h4 className="font-display font-bold text-white uppercase tracking-wider text-xs">SaaS Software</h4>
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/software" className="hover:text-brand-teal transition-colors">Campaign Manager</Link></li>
                <li><Link to="/software" className="hover:text-brand-teal transition-colors">AI Tone Adaptor</Link></li>
                <li><Link to="/software" className="hover:text-brand-teal transition-colors">Delivery Telemetry</Link></li>
                <li><Link to="/software" className="hover:text-brand-teal transition-colors">Pricing Matrix</Link></li>
              </ul>
            </div>

            {/* Division Music */}
            <div className="space-y-4">
              <h4 className="font-display font-bold text-white uppercase tracking-wider text-xs">Music Records</h4>
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/music" className="hover:text-brand-teal transition-colors">Artist Directory</Link></li>
                <li><Link to="/music" className="hover:text-brand-teal transition-colors">New Releases</Link></li>
                <li><Link to="/music" className="hover:text-brand-teal transition-colors">Submit Demo</Link></li>
                <li><Link to="/music" className="hover:text-brand-teal transition-colors">Catalog Publishing</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs font-mono text-slate-500">
                Primary Domain: <span className="text-brand-gold">storyshoutltd.com</span>
              </p>
            </div>
          </div>
